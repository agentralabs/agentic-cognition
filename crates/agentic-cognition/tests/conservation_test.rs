//! Conservation tests for AgenticCognition.
//!
...
use agentic_cognition::cache::LruCache;
use agentic_cognition::metrics::tokens::{Layer, TokenMetrics};
use agentic_cognition::query::budget::TokenBudget;
use agentic_cognition::query::intent::ExtractionIntent;
...
fn test_budget_enforcement() {
    ...
    // Spend more than remaining — returns false and does not spend
